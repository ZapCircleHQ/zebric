...
import { SchemaGenerator } from '@zebric/runtime-core'
import type { Blueprint, Entity } from '@zebric/runtime-core'
import { mkdirSync } from 'fs'
import { dirname } from 'path'
import type { SchemaDiffResult, EntityFieldChange } from '@zebric/runtime-core'
...
export class DatabaseConnection {
  ...
  private async connectSQLite(): Promise<void> {
    const dbPath = this.config.filename || './data/app.db'
