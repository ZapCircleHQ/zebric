...
Agent API v1 is under active development. Its discovery contract and safety behavior are implemented and tested, but durable jobs, managed credential rotation, and MCP transport are not yet available.
:::
