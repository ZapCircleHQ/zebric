...
import type { AuthProvider, AuthProviderConfig, UserSession } from './provider.js'
...
/**
 * Factory function to create a BetterAuthProvider instance
 */
export function createBetterAuthProvider(config: AuthProviderConfig): BetterAuthProvider {
