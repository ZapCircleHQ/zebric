...
export class AuditLogger {
   ...
   */
  log(event: Partial<AuditEvent> & { eventType: AuditEventType; action: string }): void {
   ...
   */
  logAuthSuccess(userId: string, email?: string, context?: Partial<AuditEvent>): void {
    this.log({
   ...
   */
  logAuthFailure(email: string, reason: string, context?: Partial<AuditEvent>): void {
    this.log({
   ...
   */
  private buildEvent(partial: Partial<AuditEvent> & { eventType: AuditEventType; action: string }): AuditEvent {
    return {
   ...
   */
  static extractContext(session?: UserSession | null, request?: any): Partial<AuditEvent> {
    return {
