...
- New `@zebric/observability` logging layer
- CI improvements
...
**Observability**
- Add `@zebric/observability` for structured logging, correlation IDs, redaction, and Hono middleware support

### Changed

**Cloudflare Runtime**
- Add CI coverage for runtime-worker unit and integration paths
